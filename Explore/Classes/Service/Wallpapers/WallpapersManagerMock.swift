...
final class WallpapersManagerMock: WallpapersManager {
    private struct Constants {
        static let wallpapersCacheKey = "wallpapers_manager_mock_wallpapers_cache_key"
    }
...
extension WallpapersManagerMock {
...
private extension WallpapersManagerMock {
    func retrieveWallpapers() -> Single<Wallpapers?> {
//        guard SessionManager.shared.getSession()?.userToken != nil else {
...
//        }
        ...
        return Single<Any>
            .create { event in
                guard
                    let url = Bundle.main.url(forResource: "GetWallpapersRequestJSON", withExtension: "json"),
